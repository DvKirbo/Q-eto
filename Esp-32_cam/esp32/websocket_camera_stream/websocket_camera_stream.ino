...
const char* ssid     = "JESSICA 2"; // CHANGE HERE
const char* password = "pocho.573"; // CHANGE HERE
//de mi wifi//192.168.18.145
//el que me da esp32 // 192.168.18.125
const char* websockets_server_host = "192.168.18.145"; //CHANGE HERE
